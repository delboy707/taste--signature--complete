...
//
// This is a bridge into qep-capture's tss_shared schema, used by
// signature-supabase-sync.js to dual-write Signature experiences into
// tss_shared.signature_profiles (migration 0026) alongside Firestore.
// Firestore remains the system of record; this is a secondary write for
// cross-app comparison (Brief targets vs Signature profiles vs Capture
// results). The anon key is safe to ship client-side by design - RLS is
// the sole access gate, same posture as qep-capture's own app. There is
// no service-role key here and none should ever be added to this file.
//
