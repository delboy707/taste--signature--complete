    ...
    return `
        <div class="analytics-section">
            ...
            <div class="batch-import-actions">
                ...
                <div class="qep-instructions" style="margin-top:16px;padding:16px;background:#f0f9ff;border-radius:8px;border:1px solid #bae6fd;">
                    <strong>How to import QEP data:</strong>
                    <ol style="margin:8px 0 0 20px;font-size:13px;line-height:1.8;">
                        <li>Click <em>Download QEP Full Template</em> above</li>
                        <li>Fill in your panel data - scores 0-10, leave unused columns blank</li>
                        <li>For emotions: pick from the approved list in row 2, separate with semicolons</li>
                        <li>Save as CSV and upload using the file upload below</li>
                        <li>The app detects QEP templates automatically - no column mapping needed</li>
                    </ol>
                </div>
...
async function processUploadedFile(file) {
    ...
    try {
        ...
        if (extension === 'csv') {
            ...
            // Detect QEP template by stage-prefixed column headers
            ...
            if (isQEP) {
                ...
                if (!qepResult.products.length) {
                    alert("No valid data rows found in QEP template. Please check your file.");
                    return;
                }
